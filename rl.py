...
if __name__ == "__main__":
    ...
    main_process_port = os.environ.get("MAIN_PROCESS_PORT")
    if main_process_port is None:
        main_process_port = OmegaConf.select(config, "experiment.main_process_port", default=8890)
    main_process_port = int(main_process_port)
    ...
    def train(i, target = None):
        if target is None:
            ...
            if model_base == "sdar":
                ...
                script_name = "slim_rl_sdar_policy.py"
            elif model_base == "trado":
            ...
            if model_base == "sdar":
                ...
                script_name = "slim_rl_sdar_value.py"
            elif model_base == "trado":
