...
# The eval workers (one per GPU) compile identical kernels and race to os.replace
# into the SHARED triton dir above. On a warm inductor FxGraph-cache HIT,
...
# caching themselves stay enabled for speed). Mirrors sdar_rl_rollout.py.
